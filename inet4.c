 ...
 */
static int INET_rresolve(char *name, size_t len, struct sockaddr_in *sin, int numeric, unsigned int netmask)
{
  struct hostent *ent;
  struct netent *np;
  struct addr *pn;
...
char *get_sname(int socknumber, const char *proto, int numeric)
{
